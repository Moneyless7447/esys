...
HD_PWD='C:/Users/Sascha/source/repos/esys/project_1_ab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Schieberegister_transparent.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Schieberegister_transparent.tcl
